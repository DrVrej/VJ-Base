...
-- Main
VJBASE_INSTALLED					bool				Set to true if VJ Base is installed
VJBASE_VERSION						string				Current installed version of VJ Base
VJ									table				Holds the main VJ Base library

-- Modifiers
VJBASE_DISABLE_MENU_SPAWN 			bool				Set it to true to disable the spawn menu tab
VJBASE_DISABLE_INIT_MESSAGE 		bool				Set it to true to disable the welcome message when a player joins the server

-- Errors
VJBASE_ERROR_OUTDATED_GAME			bool				Set to true if the game is running on an old unsupported version
VJBASE_ERROR_INCOMPATIBLE			bool				Set to true if an incompatible addon is detected

-- Convars & Objects
VJ_CVAR_IGNOREPLAYERS				bool				Holds the value of the "ai_ignoreplayers" convar, which determines whether or not AI ignores players
VJ_CVAR_AI_ENABLED					bool				Holds the value of the "ai_disabled" convar, which determines whether or not AI is enabled
VJ_RecipientFilter					CRecipientFilter	Holds the recipient filter that includes all players, useful for networking such as sounds
VJ_Nodegraph						table				Holds a VJ Base Nodegraph table, used to access the current map's nodegraph
*/
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------ Enumerations ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
VJ_ID_Headcrab					bool		Headcrabs (headhumpers!)
