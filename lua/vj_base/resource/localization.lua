...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		elseif conv == "turkish" then ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			...
			add("vjbase.menu.snpc.settings.label1", "AI Ayarları:")
			...
			add("vjbase.menu.snpc.settings.label2", "UYARI: Bu Bazı AI Parçalarını Bozabilir!")
			...
			add("vjbase.menu.snpc.settings.label3", "Örnek: NPC'ye doğru E'ye bastığında seni takip eder.")
			...
			add("vjbase.menu.snpc.settings.label4", "Saldırı Ayarları:")
			...
			add("vjbase.menu.snpc.settings.label5", "İnsanlar silah kullanamayacak!")
			...
			add("vjbase.menu.snpc.settings.label6", "Çeşitli Ayarlar:")
			add("vjbase.menu.snpc.settings.toggleidleparticles", "Boştaki efekt ve parçacıklar Devre Dışı")
			add("vjbase.menu.snpc.settings.label7", "Bunu devre dışı bırakmak performansı artırabilir!")
			add("vjbase.menu.snpc.settings.togglesnpcchat", "NPC Sohbet Yazıları Devre Dışı")
			add("vjbase.menu.snpc.settings.label8", "Örnek: 'Bilim adamı seni takip ediyor!'")
			add("vjbase.menu.snpc.settings.label9", "Hasar ve Ceset Ayarları:")
			...
			add("vjbase.menu.snpc.settings.label10", "Kan izleri, lekeler vs. Devre Dışı")
			...
			add("vjbase.menu.snpc.settings.label11", "Bunu devre dışı bırakmak performansı artırabilir!")
			...
			add("vjbase.menu.snpc.settings.label12", "Pasif Ayarlar:")
