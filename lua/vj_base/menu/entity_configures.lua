...
local function VJ_SNPC_OPTIONS(Panel) -- Options
	...
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.options.toggleitemdrops", Command = "vj_npc_droploot"})
...
local function VJ_SNPC_SETTINGS(Panel) -- Settings
	...
	Panel:AddControl("Label", {Text = "#vjbase.menu.snpc.settings.title.ai"})
	...
	Panel:ControlHelp("#vjbase.menu.snpc.settings.help.chasingenemy")
	...
	Panel:ControlHelp("#vjbase.menu.snpc.settings.help.followplayer")
	...
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.settings.toggleinvestigate", Command = "vj_npc_noinvestigate"})
	Panel:ControlHelp("#vjbase.menu.snpc.settings.help.investigate")
	...
	Panel:AddControl("Label", {Text = "#vjbase.menu.snpc.settings.title.attack"})
	...
	Panel:ControlHelp("#vjbase.menu.snpc.settings.help.noweapon")
	...
	Panel:AddControl("Label", {Text = "#vjbase.menu.snpc.settings.title.misc"})
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.settings.toggleidleparticles", Command = "vj_npc_noidleparticle"})
	Panel:ControlHelp("#vjbase.menu.snpc.settings.help.idleparticles")
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.settings.togglesnpcchat", Command = "vj_npc_nosnpcchat"})
	Panel:ControlHelp("#vjbase.menu.snpc.settings.help.npcchat")
	
	Panel:AddControl("Label", {Text = "#vjbase.menu.snpc.settings.title.damagecorpse"})
	...
	Panel:ControlHelp("#vjbase.menu.snpc.settings.help.bleeding")
	...
	Panel:ControlHelp("#vjbase.menu.snpc.settings.help.gib")
	...
	Panel:AddControl("Label", {Text = "#vjbase.menu.snpc.settings.title.passive"})
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.settings.togglerunontouch", Command = "vj_npc_no_runontouch"})
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.settings.togglerunonhit", Command = "vj_npc_no_runonhit"})
end
---------------------------------------------------------------------------------------------------------------------------------------------
...
local function VJ_SNPC_DEVSETTINGS(Panel) -- Developer Settings
	...
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.devsettings.toggledev", Command = "vj_npc_debug"})
	Panel:ControlHelp("#vjbase.menu.snpc.devsettings.label3")
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.devsettings.enginedebug", Command = "vj_npc_debug_engine"})
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.devsettings.printcurenemy", Command = "vj_npc_debug_enemy"})
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.devsettings.printlastseenenemy", Command = "vj_npc_debug_lastseenenemytime"})
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.devsettings.printonreset", Command = "vj_npc_debug_resetenemy"})
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.devsettings.printonstopattack", Command = "vj_npc_debug_stopattacks"})
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.devsettings.printtakingcover", Command = "vj_npc_debug_takingcover"})
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.devsettings.printondamage", Command = "vj_npc_debug_ondmg"})
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.devsettings.printondeath", Command = "vj_npc_debug_death"})
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.devsettings.printtouch", Command = "vj_npc_debug_ontouch"})
	Panel:AddControl("Checkbox", {Label = "#vjbase.menu.snpc.devsettings.printweaponinfo", Command = "vj_npc_debug_weapon"})
