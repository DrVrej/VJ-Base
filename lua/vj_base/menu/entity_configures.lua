...
local function VJ_NPC_SETTINGS_CONTROLLER(panel)
	...
	local bindList = vgui.Create("DListView")
		...
		function bindList:OnRowSelected(panel2, rowIndex, row)
			chat.AddText(VJ.COLOR_GREEN, language.GetPhrase("#vjbase.menu.npc.settings.con.bind.chat.key") .. " ", VJ.COLOR_YELLOW, row:GetValue(1), VJ.COLOR_GREEN, " | " .. language.GetPhrase("#vjbase.menu.npc.settings.con.bind.chat.desc") .. " ", VJ.COLOR_YELLOW, row:GetValue(2))
		end
