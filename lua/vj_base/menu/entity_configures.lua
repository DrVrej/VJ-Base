...
local function VJ_NPC_SETTINGS_CONTROLLER(panel)
	panel:AddControl("Label", {Text = "#vjbase.menu.npc.settings.con.header"})
	...
	panel:AddControl("Label", {Text = "#vjbase.menu.npc.settings.con.bind.header"})
...
local function VJ_WEAPON_SETTINGS_CLIENT(panel)
	panel:AddControl("Label", {Text = "#vjbase.menu.wep.settings.client.notice"})
	panel:AddControl("Button", {Text = "#vjbase.menu.general.reset.everything", Command = "vj_wep_muzzleflash 1\n vj_wep_shells 1\n vj_wep_muzzleflash_light 1"})
	panel:AddControl("Checkbox", {Label = "#vjbase.menu.wep.settings.client.toggle.muzzle", Command = "vj_wep_muzzleflash"})
	panel:AddControl("Checkbox", {Label = "#vjbase.menu.wep.settings.client.toggle.muzzlelight", Command = "vj_wep_muzzleflash_light"})
	panel:ControlHelp("#vjbase.menu.wep.settings.client.toggle.muzzlelight.label")
	panel:AddControl("Checkbox", {Label = "#vjbase.menu.wep.settings.client.toggle.shells", Command = "vj_wep_shells"})
end
