...
local strings_english = {
	...
	["vjbase.menu.npc.settings.dev.toggledev.label"] = "This option must be enabled from here or through the context menu! (Required for the options below)",
	["vjbase.menu.npc.settings.dev.enginedebug"] = "Engine Debugging (m_debugOverlays)",
	["vjbase.menu.npc.settings.dev.attackdebug"] = "Attack Debugging",
	["vjbase.menu.npc.settings.dev.damagedebug"] = "Damage Debugging",
...
local strings_russian = {
	...
	["vjbase.menu.npc.settings.dev.toggledev.label"] = "Эта опция должна быть включена здесь или через контекстное меню! (Требуется для следующих опций)",
	...
	["vjbase.menu.npc.settings.dev.attackdebug"] = "Вывод на остановку атаки (Консоль)",
	["vjbase.menu.npc.settings.dev.printtakingcover"] = "Вывод укрытия (Консоль)",
	["vjbase.menu.npc.settings.dev.damagedebug"] = "Вывод о повреждениях (Консоль)",
...
local strings_lithuanian = {
	...
	["vjbase.menu.npc.settings.dev.toggledev.label"] = "Šios parinktys turi būti įgalintos čia arba naudojant kontekstinį meniu (būtina toliau esančioms parinktims).",
	...
	["vjbase.menu.npc.settings.dev.attackdebug"] = "Spausdinti sustabdant puolimą (konsolė)",
	["vjbase.menu.npc.settings.dev.printtakingcover"] = "Spausdinti prisidengiant (konsolė)",
	["vjbase.menu.npc.settings.dev.damagedebug"] = "Spausdinti žalą (konsolė)",
...
local strings_chinese_simplified = {
	...
	["vjbase.menu.npc.settings.dev.toggledev.label"] = "必须从此处或通过关联菜单启用此选项(以下选项需要）",
	...
	["vjbase.menu.npc.settings.dev.attackdebug"] = "停止攻击时输出（控制台）",
	["vjbase.menu.npc.settings.dev.printtakingcover"] = "寻找掩护时输出（控制台）",
	["vjbase.menu.npc.settings.dev.damagedebug"] = "受到伤害时输出（控制台）",
...
local strings_turkish = {
	...
	["vjbase.menu.npc.settings.dev.toggledev.label"] = "Bu seçenek buradan ya da içerik menüsünden etkinleştirilmelidir! (Aşağıdaki seçenekler için gerekli)",
	...
	["vjbase.menu.npc.settings.dev.attackdebug"] = "Duran Saldırıları Yazdır (Konsola)",
	["vjbase.menu.npc.settings.dev.printtakingcover"] = "Siper Almayı Yazdır (Konsola)",
	["vjbase.menu.npc.settings.dev.damagedebug"] = "Hasarda Yazdır (Konsola)",
