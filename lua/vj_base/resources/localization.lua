...
local strings_english = {
	...
	["vjbase.menu.npc.settings.atk.melee.propap.header"] = "Prop Interaction:",
	["vjbase.menu.npc.settings.atk.melee.propap.disable"] = "Disable Damaging and Pushing",
	["vjbase.menu.npc.settings.atk.melee.propap.all"] = "Default | Damage and Push",
	["vjbase.menu.npc.settings.atk.melee.propap.onlydamage"] = "Only Damage",
	["vjbase.menu.npc.settings.atk.melee.propap.onlypush"] = "Only Push",
