...
local strings_english = {
	...
	["tool.vj_tool_relationship.label1"] = "Modifies the relationship of an NPC, basically how it feels towards another entity.",
	["tool.vj_tool_relationship.header"] = "Class",
	["tool.vj_tool_relationship.label2"] = "Press return to add the class.",
	...
	["tool.vj_tool_relationship.button.player"] = "Insert Player Class",
	["tool.vj_tool_relationship.togglealliedply"] = "Allied with all player allies?",
	["tool.vj_tool_relationship.label3"] = "Only applies for VJ Base SNPCs and requires the SNPC to have",
...
local strings_russian = {
	...
	["tool.vj_tool_relationship.label1"] = "Изменяет отношение NPC, в основном то, как он чувствует себя по отношению к другому объекту.",
	["tool.vj_tool_relationship.header"] = "Класс",
...
local strings_lithuanian = {
	...
	["tool.vj_tool_relationship.label1"] = "Keičia personažo santykius. Iš esmės tai, ką jis jaučia esybei.",
	["tool.vj_tool_relationship.header"] = "Klasė",
...
local strings_chinese_simplified = {
	...
	["tool.vj_tool_relationship.label1"] = "修改一个 NPC 的关系，即它对另一个实体的感觉。",
	["tool.vj_tool_relationship.header"] = "实体类别",
...
local strings_turkish = {
	...
	["tool.vj_tool_relationship.label1"] = "NPC ilişkisini düzenler, başka bir entity yanında nasıl davranacağını düzenler.",
	["tool.vj_tool_relationship.header"] = "Sınıf",
