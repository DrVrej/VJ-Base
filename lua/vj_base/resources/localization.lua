...
if CLIENT then
	...
	function VJ.RefreshLanguage()
		...
		-- SNPC Menus
		add("vjbase.menu.npc.options", "Options")
		add("vjbase.menu.npc.options.difficulty.header", "Select the Difficulty:")
		add("vjbase.menu.npc.options.difficulty.neanderthal", "[-3] Neanderthal | -99% Health and Damage")
		add("vjbase.menu.npc.options.difficulty.childs_play", "[-2] Child's Play | -75% Health and Damage")
		add("vjbase.menu.npc.options.difficulty.easy", "[-1] Easy | -50% Health and Damage")
		add("vjbase.menu.npc.options.difficulty.normal", "[0] Normal | Original Health and Damage")
		add("vjbase.menu.npc.options.difficulty.hard", "[1] Hard | +50% Health and Damage")
		add("vjbase.menu.npc.options.difficulty.insane", "[2] Insane | +100% Health and Damage")
		add("vjbase.menu.npc.options.difficulty.impossible", "[3] Impossible | +150% Health and Damage")
		add("vjbase.menu.npc.options.difficulty.nightmare", "[4] Nightmare | +250% Health and Damage")
		add("vjbase.menu.npc.options.difficulty.hell_on_earth", "[5] Hell On Earth | +350% Health and Damage")
		add("vjbase.menu.npc.options.difficulty.total_annihilation", "[6] Total Annihilation | +500% Health and Damage")
		add("vjbase.menu.npc.options.label1", "Relationship Options:")
		add("vjbase.menu.npc.options.togglefriendlyantlion", "Antlion Friendly")
		add("vjbase.menu.npc.options.togglefriendlycombine", "Combine Friendly")
		add("vjbase.menu.npc.options.togglefriendlyplayer", "Player Friendly")
		add("vjbase.menu.npc.options.togglefriendlyzombie", "Zombie Friendly")
		add("vjbase.menu.npc.options.togglefriendlyvj", "VJ Base Friendly")
		add("vjbase.menu.npc.options.label2", "All VJ NPCs will be allied!")
		add("vjbase.menu.npc.options.label3", "Corpse, Dismemberment, & Health Options:")
		add("vjbase.menu.npc.options.collision.header", "Corpse Collision:")
		add("vjbase.menu.npc.options.collision.default", "Default | Excludes: Players, NPCs, Weapons, Ragdolls")
		add("vjbase.menu.npc.options.collision.everything", "No exclusions | Everything!")
		add("vjbase.menu.npc.options.collision.onlyworld", "Only World")
		add("vjbase.menu.npc.options.collision.excludedebris", "Excludes: Corpses, Debris")
		add("vjbase.menu.npc.options.collision.excludeplynpcs", "Excludes: Players, NPCs")
		add("vjbase.menu.npc.options.collision.excludeply", "Excludes: Players")
		add("vjbase.menu.npc.options.corpselimit", "Corpse Limit, Def:32")
		add("vjbase.menu.npc.options.label4", "Corpse Limit when 'Keep Corpses' is off")
		add("vjbase.menu.npc.options.toggleundocorpses", "Undoable Corpses (Undo Key)")
		add("vjbase.menu.npc.options.togglecorpsefade", "Fade Corpses")
		add("vjbase.menu.npc.options.corpsefadetime", "Corpse Fade Time")
		add("vjbase.menu.npc.options.label5", "Total: 600 seconds (10 Minutes)")
		add("vjbase.menu.npc.options.togglegibcollision", "Collidable Gibs")
		add("vjbase.menu.npc.options.togglefadegibs", "Fade Gibs")
		add("vjbase.menu.npc.options.gibfadetime", "Gib Fade Time")
		add("vjbase.menu.npc.options.label6", "Default: 30 | Total: 600 seconds (10 Minutes)")
		add("vjbase.menu.npc.options.togglesnpcgodmode", "God Mode (They won't take any damage)")
		add("vjbase.menu.npc.options.health", "Health:")
		add("vjbase.menu.npc.options.defaulthealth", "0 = Default Health (9 digits max!)")
		add("vjbase.menu.npc.options.label7", "AI Options:")
		add("vjbase.menu.npc.options.toggleknowenemylocation", "Always Know Enemy Location")
		add("vjbase.menu.npc.options.sightdistance", "Sight Distance:")
		add("vjbase.menu.npc.options.label8", "Each NPC has its own distance, but this will make them all the same, so use it cautiously! (0 = Original | Average: 10k)")
		add("vjbase.menu.npc.options.label10", "Miscellaneous Options:")
		add("vjbase.menu.npc.options.togglegmoddecals", "Use Garry's Mod's Current Blood Decals")
		add("vjbase.menu.npc.options.label11", "Only for Yellow and Red colors!")
		add("vjbase.menu.npc.options.toggleitemdrops", "Loot Drops On Death")
		add("vjbase.menu.npc.options.toggleaddfrags", "Add points to the player's scoreboard when killed")
		add("vjbase.menu.npc.options.togglecreatureopendoor", "Creatures Can Open Doors")
		add("vjbase.menu.npc.options.togglehumansdropweapon", "Humans Drop Weapon On Death")
		add("vjbase.menu.npc.options.togglehumanscanjump", "Humans Can Jump")
		add("vjbase.menu.npc.options.toggleplydroppedweapons", "Players Can Pick Up Dropped Weapons")
		
		add("vjbase.menu.npc.settings", "Settings")
		add("vjbase.menu.npc.settings.title.ai", "AI Settings:")
		add("vjbase.menu.npc.settings.togglewandering", "Disable Wandering When Idle")
		add("vjbase.menu.npc.settings.togglechasingenemy", "Disable Chasing Enemy")
		add("vjbase.menu.npc.settings.help.chasingenemy", "WARNING: This can break parts of the AI!")
		add("vjbase.menu.npc.settings.togglemedics", "Disable Medic NPCs")
		add("vjbase.menu.npc.settings.togglefollowplayer", "Disable Following Player")
		add("vjbase.menu.npc.settings.help.followplayer", "Example: When you press 'E' on a NPC and they follow you")
		add("vjbase.menu.npc.settings.toggleallies", "Disable Alliance (No Allies!)")
		add("vjbase.menu.npc.settings.togglebecomeenemytoply", "Disable Allies Becoming Enemy")
		add("vjbase.menu.npc.settings.togglecallhelp", "Disable Calling for Help")
		add("vjbase.menu.npc.settings.toggleinvestigate", "Disable Detecting & Investigating Disturbances")
		add("vjbase.menu.npc.settings.help.investigate", "Examples: Sounds, movement, flashlight, bullet hits")
		add("vjbase.menu.npc.settings.toggleproppush", "Disable Prop Pushing (Creatures)")
		add("vjbase.menu.npc.settings.togglepropattack", "Disable Prop Attacking (Creatures)")
		add("vjbase.menu.npc.settings.toggledangersight", "Disable Detecting Dangers & Grenades (Humans)")
		add("vjbase.menu.npc.settings.togglereloading", "Disable Weapon Reloading")
		add("vjbase.menu.npc.settings.toggleeating", "Disable Eating (EX: Corpses or gibs)")
		add("vjbase.menu.npc.settings.title.attack", "Attack Settings:")
		add("vjbase.menu.npc.settings.togglemelee", "Disable Melee Attacks")
		add("vjbase.menu.npc.settings.togglerange", "Disable Range Attacks")
		add("vjbase.menu.npc.settings.toggleleap", "Disable Leap Attacks (Creatures)")
		add("vjbase.menu.npc.settings.togglethrownade", "Disable Grenade Attacks (Humans)")
		add("vjbase.menu.npc.settings.toggleweapons", "Disable Weapons (Humans)")
		add("vjbase.menu.npc.settings.help.noweapon", "Humans will not be able to use weapons!")
		add("vjbase.menu.npc.settings.togglemeleedsp", "Disable DSP Effect On Heavy Melee Damages")
		add("vjbase.menu.npc.settings.toggleslowplayer", "Disable Players Slowing Down on Melee Attack")
		add("vjbase.menu.npc.settings.togglebleedonmelee", "Disable Players/NPCs Bleeding on Melee Attack")
		add("vjbase.menu.npc.settings.title.misc", "Miscellaneous Settings:")
		add("vjbase.menu.npc.settings.toggleidleparticles", "Disable Idle Particles and Effects")
		add("vjbase.menu.npc.settings.help.idleparticles", "Disabling this can help with performance")
		add("vjbase.menu.npc.settings.togglesnpcchat", "Disable NPC Chat Prints")
		add("vjbase.menu.npc.settings.help.npcchat", "For example: 'Scientist is now following you'")
		add("vjbase.menu.npc.settings.title.damagecorpse", "Damage & Corpse Settings:")
		add("vjbase.menu.npc.settings.toggleflinching", "Disable Flinching")
		add("vjbase.menu.npc.settings.togglebleeding", "Disable Bleeding")
		add("vjbase.menu.npc.settings.help.bleeding", "Disables blood particles, decals, pools etc.")
		add("vjbase.menu.npc.settings.togglebloodpool", "Disable Blood Pools On Death")
		add("vjbase.menu.npc.settings.togglegib", "Disable Gibbing")
		add("vjbase.menu.npc.settings.help.gib", "Disabling this can help with performance")
		add("vjbase.menu.npc.settings.togglegibdeathvfx", "Disable Gib/Death VFX (particles, decals, etc.)")
		add("vjbase.menu.npc.settings.toggledeathanim", "Disable Death Animation")
		add("vjbase.menu.npc.settings.togglecorpses", "Disable Corpses")
		add("vjbase.menu.npc.settings.title.passive", "Passive Settings:")
		add("vjbase.menu.npc.settings.togglerunontouch", "Disable Running on Touch")
		add("vjbase.menu.npc.settings.togglerunonhit", "Disable Running on Damage")
		
		add("vjbase.menu.npc.sdsettings", "Sound Settings")
		add("vjbase.menu.npc.sdsettings.toggleallsounds", "Disable All Sounds")
		add("vjbase.menu.npc.sdsettings.togglesoundtrack", "Disable Sound Tracks / Music")
		add("vjbase.menu.npc.sdsettings.toggleidle", "Disable Idle Sounds")
		add("vjbase.menu.npc.sdsettings.togglebreathing", "Disable Breathing Sounds")
		add("vjbase.menu.npc.sdsettings.togglefootsteps", "Disable Footstep Sounds")
		add("vjbase.menu.npc.sdsettings.toggleattacksounds", "Disable Melee Attack Sounds")
		add("vjbase.menu.npc.sdsettings.togglerangeattack", "Disable Range Attack Sounds")
		add("vjbase.menu.npc.sdsettings.togglealert", "Disable Alert Sounds")
		add("vjbase.menu.npc.sdsettings.togglepain", "Disable Pain Sounds")
		add("vjbase.menu.npc.sdsettings.toggledeath", "Disable Death Sounds")
		add("vjbase.menu.npc.sdsettings.togglegibbing", "Disable Gibbing Sounds")
		add("vjbase.menu.npc.sdsettings.label1", "Also applies to the sounds that play when a gib collides with something")
		add("vjbase.menu.npc.sdsettings.togglemedic", "Disable Medic Sounds")
		add("vjbase.menu.npc.sdsettings.togglefollowing", "Disable Following Sounds")
		add("vjbase.menu.npc.sdsettings.togglecallhelp", "Disable Calling for Help Sounds")
		add("vjbase.menu.npc.sdsettings.togglereceiveorder", "Disable Receiving Order Sounds")
		add("vjbase.menu.npc.sdsettings.togglebecomeenemy", "Disable Become Enemy to Player Sounds")
		add("vjbase.menu.npc.sdsettings.toggleplayersight", "Disable Player Sighting Sounds")
		add("vjbase.menu.npc.sdsettings.label2", "Special sounds that play when an NPC sees a player")
		add("vjbase.menu.npc.sdsettings.toggledmgbyplayer", "Disable Damage By Player Sounds")
		add("vjbase.menu.npc.sdsettings.label3", "When a player shoots at an NPC, usually friendly NPCs")
		add("vjbase.menu.npc.sdsettings.toggleleap", "Disable Leap Attack Sounds")
		add("vjbase.menu.npc.sdsettings.toggleslowedplayer", "Disable Slowed Player Sounds")
		add("vjbase.menu.npc.sdsettings.label4", "Sounds that play when the player is slowed down by melee attack")
		add("vjbase.menu.npc.sdsettings.togglegrenade", "Disable Grenade Attack Sounds")
		add("vjbase.menu.npc.sdsettings.toggledangersight", "Disable Grenade & Danger Sight Sounds")
		add("vjbase.menu.npc.sdsettings.togglesuppressing", "Disable Suppressing Call Out Sounds")
		add("vjbase.menu.npc.sdsettings.togglereload", "Disable Reload Call Out Sounds")
		
		add("vjbase.menu.npc.devsettings", "Developer Settings")
		add("vjbase.menu.npc.devsettings.label1", "These settings are used when developing SNPCs.")
		add("vjbase.menu.npc.devsettings.label2", "WARNING: Some of these options cause lag!")
		add("vjbase.menu.npc.devsettings.toggledev", "Enable Developer Mode?")
		add("vjbase.menu.npc.devsettings.label3", "This option must be enabled from here or through the context menu! (Required for the options below)")
		add("vjbase.menu.npc.devsettings.enginedebug", "Engine Debugging (m_debugOverlays)")
		add("vjbase.menu.npc.devsettings.printtouch", "Print On Touch (Console)")
		add("vjbase.menu.npc.devsettings.printcurenemy", "Print Current Enemy (Console)")
		add("vjbase.menu.npc.devsettings.printlastseenenemy", "Print 'LastSeenEnemy' time (Chat)")
		add("vjbase.menu.npc.devsettings.printonreset", "Print On Reset Enemy (Console)")
		add("vjbase.menu.npc.devsettings.printonstopattack", "Print On Stopped Attacks (Console)")
		add("vjbase.menu.npc.devsettings.printtakingcover", "Print Taking Cover (Console)")
		add("vjbase.menu.npc.devsettings.printondamage", "Print On Damage (Console)")
		add("vjbase.menu.npc.devsettings.printondeath", "Print On Death (Console)")
		add("vjbase.menu.npc.devsettings.printweaponinfo", "Print Weapon Information (Console)")
		add("vjbase.menu.npc.devsettings.cachedmodels", "Print Cached Models (Console)")
		add("vjbase.menu.npc.devsettings.numofnpcs", "Print Number of NPCs (Chat)")
		add("vjbase.menu.npc.devsettings.label4", "Reload Buttons:")
		add("vjbase.menu.npc.devsettings.reloadsounds", "Reload Sounds")
		add("vjbase.menu.npc.devsettings.reloadmaterials", "Reload Materials (VMTs)")
		add("vjbase.menu.npc.devsettings.reloadtextures", "Reload Textures (VTFs)")
		add("vjbase.menu.npc.devsettings.reloadmodels", "Reload Models")
		add("vjbase.menu.npc.devsettings.reloadspawnmenu", "Reload Spawn Menu")
		
		add("vjbase.menu.npc.performance", "Performance Settings")
		add("vjbase.menu.npc.performance.initial.label", "Use these settings to improve the performance of NPCs.")
		add("vjbase.menu.npc.performance.processtime", "Process Time")
		add("vjbase.menu.npc.performance.processtime.button", "What is Process Time?")
		add("vjbase.menu.npc.performance.processtime.label", "Default: 1 | Lower number causes more lag!")
		add("vjbase.menu.npc.performance.poseparams", "Use Pose Parameters")
		add("vjbase.menu.npc.performance.poseparams.label", "WARNING: Disabling can break NPCs that rely on it!")
		add("vjbase.menu.npc.performance.shadows", "Draw Shadows")
		add("vjbase.menu.npc.performance.ikchains", "Inverse Kinematics (IK Chains)")
		add("vjbase.menu.npc.performance.forcelowlod", "Force Use Lowest LOD")
		
		add("vjbase.menu.npc.consettings", "Controller Settings")
		add("vjbase.menu.npc.consettings.label1", "Notice: These are client-side settings only!")
		add("vjbase.menu.npc.consettings.label2", "How far or close the zoom changes every click.")
		add("vjbase.menu.npc.consettings.displayhud", "Display HUD")
		add("vjbase.menu.npc.consettings.camzoomdistance", "Camera Move Distance")
		add("vjbase.menu.npc.consettings.camspeed", "Camera Speed")
		add("vjbase.menu.npc.consettings.camzoomspeed", "Camera Zoom Speed" )
		add("vjbase.menu.npc.consettings.diewithnpc", "Controller Dies With The NPC (Requires respawn!)")
		add("vjbase.menu.npc.consettings.displaydev", "Display Developer Entities")
		add("vjbase.menu.npc.consettings.label3", "Key Bindings:")
		add("vjbase.menu.npc.consettings.bind.header1", "Control")
		add("vjbase.menu.npc.consettings.bind.header2", "Description")
		add("vjbase.menu.npc.consettings.bind.clickmsg1", "Selected Key:")
		add("vjbase.menu.npc.consettings.bind.clickmsg2", "Description:")
		add("vjbase.menu.npc.consettings.bind.movement", "Movement (Supports 8-Way)")
		add("vjbase.menu.npc.consettings.bind.exitcontrol", "Exit the Controller")
		add("vjbase.menu.npc.consettings.bind.meleeattack", "Melee Attack")
		add("vjbase.menu.npc.consettings.bind.rangeattack", "Range / Weapon Attack")
		add("vjbase.menu.npc.consettings.bind.leaporgrenade", "Leap / Grenade Attack")
		add("vjbase.menu.npc.consettings.bind.reloadweapon", "Reload Weapon")
		add("vjbase.menu.npc.consettings.bind.togglebullseye", "Toggle Bullseye Tracking")
		add("vjbase.menu.npc.consettings.bind.cameramode", "Change Camera Mode")
		add("vjbase.menu.npc.consettings.bind.movementjump", "Toggle Movement Jumping")
		add("vjbase.menu.npc.consettings.bind.camerazoom", "Zoom In & Out")
		add("vjbase.menu.npc.consettings.bind.cameraup", "Move Camera Up")
		add("vjbase.menu.npc.consettings.bind.cameradown", "Move Camera Down")
		add("vjbase.menu.npc.consettings.bind.cameraforward", "Move Camera Forward")
		add("vjbase.menu.npc.consettings.bind.camerabackward", "Move Camera Backward")
		add("vjbase.menu.npc.consettings.bind.cameraleft", "Move Camera Left")
		add("vjbase.menu.npc.consettings.bind.cameraright", "Move Camera Right")
		add("vjbase.menu.npc.consettings.bind.resetzoom", "Reset Camera Position")
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		elseif conv == "russian" then ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			...
			add("vjbase.menu.npc.performance.processtime", "Время процесса")
			add("vjbase.menu.npc.performance.processtime.button", "Что такое \"Время процесса\"?")
			add("vjbase.menu.npc.performance.processtime.label", "По умолчанию: 1 | меньшее число вызывает большую задержку игры!")
			...
			add("vjbase.menu.npc.settings.help.chasingenemy", "ВНИМАНИЕ: Это может привести к поломке частей искусственного интеллекта!")
			...
			add("vjbase.menu.npc.settings.help.followplayer", "Пример: когда вы нажимаете \"У\" на NPC, они следуют за вами")
			...
			add("vjbase.menu.npc.settings.help.noweapon", "Люди не смогут использовать оружие!")
			...
			add("vjbase.menu.npc.settings.help.idleparticles", "Отключение этого пункта может увеличить производительность")
			add("vjbase.menu.npc.settings.togglesnpcchat", "Выключить сообщения NPC в чате")
			add("vjbase.menu.npc.settings.help.npcchat", "Например: \"Учёный теперь следует за вами\".")
			...
			add("vjbase.menu.npc.settings.help.bleeding", "Отключает частицы крови, декали, лужи и т.д.")
			...
			add("vjbase.menu.npc.settings.help.gib", "Отключение этого может увеличить производительность")
			...
			add("vjbase.menu.npc.sdsettings", "Настройки звука")
			add("vjbase.menu.npc.sdsettings.toggleallsounds", "Отключить все звуки")
			add("vjbase.menu.npc.sdsettings.togglesoundtrack", "Отключить звуковые дорожки / музыку")
			add("vjbase.menu.npc.sdsettings.toggleidle", "Отключить звуки повреждений")
			add("vjbase.menu.npc.sdsettings.togglebreathing", "Отключить звуки дыхания")
			add("vjbase.menu.npc.sdsettings.togglefootsteps", "Отключить звуки шагов")
			add("vjbase.menu.npc.sdsettings.toggleattacksounds", "Отключить звуки атаки в ближнем бою")
			add("vjbase.menu.npc.sdsettings.togglerangeattack", "Отключить звуки атак в дальнем бою")
			add("vjbase.menu.npc.sdsettings.togglealert", "Отключить звуки оповещения")
			add("vjbase.menu.npc.sdsettings.togglepain", "Отключить звуки боли")
			add("vjbase.menu.npc.sdsettings.toggledeath", "Отключить звуки смерти")
			add("vjbase.menu.npc.sdsettings.togglegibbing", "Отключить звуки ошмётков")
			add("vjbase.menu.npc.sdsettings.label1", "Также относится к звукам, которые воспроизводятся, когда ошмётки сталкивается с чем-то")
			add("vjbase.menu.npc.sdsettings.togglemedic", "Отключить звуки медицины")
			add("vjbase.menu.npc.sdsettings.togglefollowing", "Отключить звуки следования")
			add("vjbase.menu.npc.sdsettings.togglecallhelp", "Отключить звуки просьб о помощи")
			add("vjbase.menu.npc.sdsettings.togglereceiveorder", "Отключить звуки получения приказов")
			add("vjbase.menu.npc.sdsettings.togglebecomeenemy", "Отключить звуки становления врагом для игрока")
			add("vjbase.menu.npc.sdsettings.toggleplayersight", "Отключить звуки прицеливания игрока")
			add("vjbase.menu.npc.sdsettings.label2", "Специальные звуки, которые воспроизводятся, когда NPC видит игрока")
			add("vjbase.menu.npc.sdsettings.toggledmgbyplayer", "Отключить звуки урона от игрока")
			add("vjbase.menu.npc.sdsettings.label3", "Когда игрок стреляет в NPC, обычно дружественные NPC")
			add("vjbase.menu.npc.sdsettings.toggleleap", "Отключить звуки атаки в прыжке")
			add("vjbase.menu.npc.sdsettings.toggleslowedplayer", "Отключить звуки замедления игрока")
			add("vjbase.menu.npc.sdsettings.label4", "Звуки, которые воспроизводятся, когда игрок замедляется в рукопашной атаке")
			add("vjbase.menu.npc.sdsettings.togglegrenade", "Отключить звуки атаки гранатой")
			add("vjbase.menu.npc.sdsettings.toggledangersight", "Отключить звуки обнаружения гранаты и опасности")
			add("vjbase.menu.npc.sdsettings.togglesuppressing", "Отключить подавление звуков взрыва")
			add("vjbase.menu.npc.sdsettings.togglereload", "Отключить перезагрузку звуков вызова")
			
			add("vjbase.menu.npc.devsettings", "Настройки разработчика")
			add("vjbase.menu.npc.devsettings.label1", "Эти настройки используются при разработке SNPC.")
			add("vjbase.menu.npc.devsettings.label2", "Предупреждение: некоторые из этих опций вызывают задержку игры!")
			add("vjbase.menu.npc.devsettings.toggledev", "Включить режим разработчика?")
			add("vjbase.menu.npc.devsettings.label3", "Эта опция должна быть включена здесь или через контекстное меню! (Требуется для следующих опций)")
			add("vjbase.menu.npc.devsettings.printtouch", "Вывод на табло (Консоль)")
			add("vjbase.menu.npc.devsettings.printcurenemy", "Вывод текущего врага (Консоль)")
			add("vjbase.menu.npc.devsettings.printlastseenenemy", "Вывод времени \"LastSeenEnemy\" (Чат)")
			add("vjbase.menu.npc.devsettings.printonreset", "Вывод на сброс противника (Консоль)")
			add("vjbase.menu.npc.devsettings.printonstopattack", "Вывод на остановку атаки (Консоль)")
			add("vjbase.menu.npc.devsettings.printtakingcover", "Вывод укрытия (Консоль)")
			add("vjbase.menu.npc.devsettings.printondamage", "Вывод о повреждениях (Консоль)")
			add("vjbase.menu.npc.devsettings.printondeath", "Вывод о смерти (Консоль)")
			add("vjbase.menu.npc.devsettings.printweaponinfo", "Вывод информации об оружии(Консоль)")
			add("vjbase.menu.npc.devsettings.cachedmodels", "Вывод кэшированных моделей (Консоль)")
			add("vjbase.menu.npc.devsettings.numofnpcs", "Вывод количества NPC (Чат)")
			add("vjbase.menu.npc.devsettings.label4", "Перезагрузить кнопки:")
		    add("vjbase.menu.npc.devsettings.reloadsounds", "Перезагрузить звуки")
		    add("vjbase.menu.npc.devsettings.reloadmaterials", "Перезагрузить материалы (VMT)")
		    add("vjbase.menu.npc.devsettings.reloadtextures", "Перезагрузить текстуры (VTF)")
		    add("vjbase.menu.npc.devsettings.reloadmodels", "Перезагрузить модели")
		    add("vjbase.menu.npc.devsettings.reloadspawnmenu", "Перезагрузить меню создания")
			
			add("vjbase.menu.npc.consettings", "Настройки контроллера")
			add("vjbase.menu.npc.consettings.label1", "Обратите внимание : это настройки только на стороне клиента!")
			add("vjbase.menu.npc.consettings.label2", "Как далеко или близко масштаб изменяется с каждым щелчком мыши.")
			add("vjbase.menu.npc.consettings.displayhud", "Отображать интерфейс")
			add("vjbase.menu.npc.consettings.camzoomdistance", "Дист-ция приближения камеры")
			add("vjbase.menu.npc.consettings.camspeed", "Скорость камеры")
		    add("vjbase.menu.npc.consettings.camzoomspeed", "Скор-сть приближения камеры")
			add("vjbase.menu.npc.consettings.diewithnpc", "Контроллер погибает вместе с NPC (После возрождения!)")
			add("vjbase.menu.npc.consettings.displaydev", "Отображение энтити разработчика")
			add("vjbase.menu.npc.consettings.label3", "Привязка клавиш:")
			add("vjbase.menu.npc.consettings.bind.header1", "Контроль")
			add("vjbase.menu.npc.consettings.bind.header2", "Описание")
			add("vjbase.menu.npc.consettings.bind.clickmsg1", "Выбранная кнопка:")
			add("vjbase.menu.npc.consettings.bind.clickmsg2", "Описание:")
			add("vjbase.menu.npc.consettings.bind.movement", "Движение")
			add("vjbase.menu.npc.consettings.bind.exitcontrol", "Выход из контроллера")
			add("vjbase.menu.npc.consettings.bind.meleeattack", "Атака в ближнем бою")
			add("vjbase.menu.npc.consettings.bind.rangeattack", "Атака в дальнем бою")
			add("vjbase.menu.npc.consettings.bind.leaporgrenade", "Прыжок/атака гранатой")
			add("vjbase.menu.npc.consettings.bind.reloadweapon", "Перезарядка")
			add("vjbase.menu.npc.consettings.bind.togglebullseye", "Отслеж-ние зоны прицеливания")
			add("vjbase.menu.npc.consettings.bind.cameramode", "Сменить режим камеры")
			add("vjbase.menu.npc.consettings.bind.movementjump", "Переключение прыжка во время движения")
		    add("vjbase.menu.npc.consettings.bind.camerazoom", "Приблизить и отдалить")
			add("vjbase.menu.npc.consettings.bind.cameraup", "Сдвинуть камеру вверх")
			add("vjbase.menu.npc.consettings.bind.cameradown", "Сдвинуть камеру вниз")
			add("vjbase.menu.npc.consettings.bind.cameraforward", "Сдвинуть камеру вперёд")
			add("vjbase.menu.npc.consettings.bind.camerabackward", "Сдвинуть камеру назад")
			add("vjbase.menu.npc.consettings.bind.cameraleft", "Сдвинуть камеру влево")
			add("vjbase.menu.npc.consettings.bind.cameraright", "Сдвинуть камеру вправо")
			add("vjbase.menu.npc.consettings.bind.resetzoom", "Сбросить позицию камеры")
		...
		elseif conv == "lithuanian" then ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			...
			add("vjbase.menu.npc.performance.processtime", "Apdorojimo laikas")
			add("vjbase.menu.npc.performance.processtime.button", "Kas yra apdorojimo laikas?")
			add("vjbase.menu.npc.performance.processtime.label", "Numatyta: 1 | Mažesnė vertė reiškia mažiau stabilesnį žaidimą!")
			...
			add("vjbase.menu.npc.settings.help.chasingenemy", "Naudokitės šiuo nustatymu atsargiai, jis gali sugadinti daug dalykų!")
			...
			add("vjbase.menu.npc.settings.help.followplayer", "Pavyzdys: kai spustelite E ant SNPC personažo, jie jus seks")
			...
			add("vjbase.menu.npc.settings.help.noweapon", "Žmonės negalės naudoti ginklų!")
			...
			add("vjbase.menu.npc.settings.help.idleparticles", "Išjungimas gali padėti našumui")
			add("vjbase.menu.npc.settings.togglesnpcchat", "Išjungti SNPC personažų pokalbį")
			add("vjbase.menu.npc.settings.help.npcchat", "Pavyzdžiui: „Mokslininkas dabar jus seka“")
			...
			add("vjbase.menu.npc.settings.help.bleeding", "Išjungia kraujo daleles, lipdukus, balas ir t.t.")
			...
			add("vjbase.menu.npc.settings.help.gib", "Išjungimas gali padėti našumui")
			...
			add("vjbase.menu.npc.sdsettings", "Garso nustatymai")
			add("vjbase.menu.npc.sdsettings.toggleallsounds", "Išjungti visus garsus")
			add("vjbase.menu.npc.sdsettings.togglesoundtrack", "Išjungti garso takelius")
			add("vjbase.menu.npc.sdsettings.toggleidle", "Išjungti neveikimo garsus")
			add("vjbase.menu.npc.sdsettings.togglebreathing", "Išjungti kvėpavimo garsus")
			add("vjbase.menu.npc.sdsettings.togglefootsteps", "Išjungti žingsnių garsus")
			add("vjbase.menu.npc.sdsettings.toggleattacksounds", "Išjungti artimos kovos puolimo garsus")
			add("vjbase.menu.npc.sdsettings.togglerangeattack", "Išjungti tolimos kovos puolimų garsus")
			add("vjbase.menu.npc.sdsettings.togglealert", "Išjungti įspėjimo garsus")
			add("vjbase.menu.npc.sdsettings.togglepain", "Išjungti skausmo garsus")
			add("vjbase.menu.npc.sdsettings.toggledeath", "Išjungti mirties garsus")
			add("vjbase.menu.npc.sdsettings.togglegibbing", "Išjungti kūno dalių nutraukimo garsus")
			add("vjbase.menu.npc.sdsettings.label1", "Taip pat taikoma garsams, kurie skamba, kai daiktas su kažkuo susiduria")
			add("vjbase.menu.npc.sdsettings.togglemedic", "Išjungti gydytojo garsus")
			add("vjbase.menu.npc.sdsettings.togglefollowing", "Išjungti sekimo garsus")
			add("vjbase.menu.npc.sdsettings.togglecallhelp", "Išjungti pakalbos kvietimo garsus")
			add("vjbase.menu.npc.sdsettings.togglereceiveorder", "Išjungti įsakymų gavimo garsus")
			add("vjbase.menu.npc.sdsettings.togglebecomeenemy", "Išjungti tapimo priešu garsus")
			add("vjbase.menu.npc.sdsettings.toggleplayersight", "Išjungti žaidėjo pamatymo garsus")
			add("vjbase.menu.npc.sdsettings.label2", "Suskamba ypatingas garsas, kai SNPC personažas pamato žaidėją")
			add("vjbase.menu.npc.sdsettings.toggledmgbyplayer", "Išjungti žaidėjo daromos žalos garsus")
			add("vjbase.menu.npc.sdsettings.label3", "Kai žaidėjas šauna į SNPC personažą, paprastai draugiški SNPC personažai")
			add("vjbase.menu.npc.sdsettings.toggleleap", "Išjungti puolimų su šuoliu garsus")
			add("vjbase.menu.npc.sdsettings.toggleslowedplayer", "Išjungti sulėtintų žaidėjų garsus")
			add("vjbase.menu.npc.sdsettings.label4", "Skambantys garsai, kai žadėją sulėtiną artimos kovos puolimas")
			add("vjbase.menu.npc.sdsettings.togglegrenade", "Išjungti granatos puolimo garsus")
			add("vjbase.menu.npc.sdsettings.togglegrenadesight", "Išjungti granatos pamatymo garsus")
			add("vjbase.menu.npc.sdsettings.togglesuppressing", "Išjungti slopinimo sušukimo garsus")
			add("vjbase.menu.npc.sdsettings.togglereload", "Išjungti užtaisymo sušukimo garsus")

			add("vjbase.menu.npc.devsettings", "Kūrėjo nustatymai")
			add("vjbase.menu.npc.devsettings.label1", "Šie nustatymai yra naudojami kuriant SNPC personažus.")
			add("vjbase.menu.npc.devsettings.label2", "ĮSPĖJIMAS: kai kurios parinktys prives prie žaidimo strigimo!")
			add("vjbase.menu.npc.devsettings.toggledev", "Įgalinti kūrėjo režimą?")
			add("vjbase.menu.npc.devsettings.label3", "Šios parinktys turi būti įgalintos čia arba naudojant kontekstinį meniu (būtina toliau esančioms parinktims).")
			add("vjbase.menu.npc.devsettings.printtouch", "Spausdinti prisilėtus (konsolė)")
			add("vjbase.menu.npc.devsettings.printcurenemy", "Spausdinti dabartinį priešą (konsolė)")
			add("vjbase.menu.npc.devsettings.printlastseenenemy", "Spausdinti laiką „LastSeenEnemy“ (pokalbis)")
			add("vjbase.menu.npc.devsettings.printonreset", "Spausdinti atkuriant priešą (konsolė)")
			add("vjbase.menu.npc.devsettings.printonstopattack", "Spausdinti sustabdant puolimą (konsolė)")
			add("vjbase.menu.npc.devsettings.printtakingcover", "Spausdinti prisidengiant (konsolė)")
			add("vjbase.menu.npc.devsettings.printondamage", "Spausdinti žalą (konsolė)")
			add("vjbase.menu.npc.devsettings.printondeath", "Spausdinti mirtį (konsolė)")
			add("vjbase.menu.npc.devsettings.printweapon", "Spausdinti dabartinį ginklą (konsolė)")
			add("vjbase.menu.npc.devsettings.printammo", "Spausdinti šovinių skaičių (konsolė)")
			add("vjbase.menu.npc.devsettings.printaccuracy", "Spausdinti ginklo tikslumą (konsolė)")
			add("vjbase.menu.npc.devsettings.cachedmodels", "Modeliai podėlyje (konsolė)")
			add("vjbase.menu.npc.devsettings.numofnpcs", "Personažų skaičius (pokalbis)")
			add("vjbase.menu.npc.devsettings.reloadsounds", "Iš naujo įkelti garsus")
			add("vjbase.menu.npc.devsettings.reloadmaterials", "Iš naujo įkelti medžiagas (VMT)")
			add("vjbase.menu.npc.devsettings.reloadtextures", "Iš naujo įkelti tekstūras (VTF)")
			add("vjbase.menu.npc.devsettings.reloadmodels", "Iš naujo modelius")
			add("vjbase.menu.npc.devsettings.reloadspawnmenu", "Iš naujo įkelti objektų sąrašus")

			add("vjbase.menu.npc.consettings", "Valdymo nustatymai")
			add("vjbase.menu.npc.consettings.label1", "Dėmesio: tai yra klientiniai nustatymai!")
			add("vjbase.menu.npc.consettings.label2", "Kaip toli ar arti pasikeičia priartinimas po kiekvieno spustelėjimo.")
			add("vjbase.menu.npc.consettings.displayhud", "Rodyti HUD")
			add("vjbase.menu.npc.consettings.camzoomdistance", "Kameros judėjimo atstumas")
			add("vjbase.menu.npc.consettings.camspeed", "Kameros greitis")
			add("vjbase.menu.npc.consettings.camzoomspeed", "Kameros priartinimo greitis" )
			add("vjbase.menu.npc.consettings.diewithnpc", "Valdytojas miršta kartu su personažu (reikalauja prisikėlimo iš naujo!)")
			add("vjbase.menu.npc.consettings.displaydev", "Rodyti kūrėjo esybes")
			add("vjbase.menu.npc.consettings.label3", "Klavišų priskyrimas:")
			add("vjbase.menu.npc.consettings.bind.header1", "Valdyti")
			add("vjbase.menu.npc.consettings.bind.header2", "Aprašas")
			add("vjbase.menu.npc.consettings.bind.clickmsg1", "Pasirinktas klavišas:")
			add("vjbase.menu.npc.consettings.bind.clickmsg2", "Aprašas:")
			add("vjbase.menu.npc.consettings.bind.movement", "Judėjimas (palaiko 8-Way)")
			add("vjbase.menu.npc.consettings.bind.exitcontrol", "Išeiti iš valdymo")
			add("vjbase.menu.npc.consettings.bind.meleeattack", "Artimos kovos puolimas")
			add("vjbase.menu.npc.consettings.bind.rangeattack", "Tolimos kovos puolimas")
			add("vjbase.menu.npc.consettings.bind.leaporgrenade", "Puolimas su šuoliu/granata")
			add("vjbase.menu.npc.consettings.bind.reloadweapon", "Užtaisyti ginklą")
			add("vjbase.menu.npc.consettings.bind.togglebullseye", "Perjungti personažo-taikinio sekimą")
			add("vjbase.menu.npc.consettings.bind.cameramode", "Keisti kameros režimą")
			add("vjbase.menu.npc.consettings.bind.camerazoom", "Priartinti ir nutolinti")
			add("vjbase.menu.npc.consettings.bind.cameraup", "Perkelti kamerą aukštyn")
			add("vjbase.menu.npc.consettings.bind.cameradown", "Perkelti kamerą žemyn")
			add("vjbase.menu.npc.consettings.bind.cameraforward", "Perkelti kamerą pirmyn")
			add("vjbase.menu.npc.consettings.bind.camerabackward", "Perkelti kamerą atgal")
			add("vjbase.menu.npc.consettings.bind.cameraleft", "Perkelti kamerą kairėn")
			add("vjbase.menu.npc.consettings.bind.cameraright", "Perkelti kamerą dešinėn")
			add("vjbase.menu.npc.consettings.bind.resetzoom", "Atkurti kameros poziciją")
		...
		elseif conv == "schinese" then ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			...
			add("vjbase.menu.npc.performance.processtime", "处理时间")
			add("vjbase.menu.npc.performance.processtime.button", "什么是处理时间？")
			add("vjbase.menu.npc.performance.processtime.label", "默认：1 | 越低的数字会导致更多的卡顿！")
			...
			add("vjbase.menu.npc.settings.help.chasingenemy", "小心使用这个设置，它可以破坏很多东西！")
			add("vjbase.menu.npc.settings.togglemedics", "禁用医疗兵 SNPC")
			add("vjbase.menu.npc.settings.togglefollowplayer", "禁止跟随玩家")
			add("vjbase.menu.npc.settings.help.followplayer", "例如：你对着一个 SNPC 按下“E”键，它们就会跟着你")
			...
			add("vjbase.menu.npc.settings.help.noweapon", "人类将不能使用武器！")
			...
			add("vjbase.menu.npc.settings.help.idleparticles", "启用此选项可以提高性能")
			add("vjbase.menu.npc.settings.togglesnpcchat", "禁用 SNPC 聊天框信息")
			add("vjbase.menu.npc.settings.help.npcchat", "例如：“科学家 现在正跟着你”")
			...
			add("vjbase.menu.npc.settings.help.bleeding", "禁用血液粒子效果，贴图，血泊等。")
			add("vjbase.menu.npc.settings.togglebloodpool", "禁用血泊（死亡时）")
			add("vjbase.menu.npc.settings.togglegib", "禁用碎尸")
			add("vjbase.menu.npc.settings.help.gib", "启用此选项可以提高性能")
			...
			add("vjbase.menu.npc.sdsettings", "声音设置")
			add("vjbase.menu.npc.sdsettings.toggleallsounds", "禁用所有声音")
			add("vjbase.menu.npc.sdsettings.togglesoundtrack", "禁用音轨/音乐")
			add("vjbase.menu.npc.sdsettings.toggleidle", "禁用空闲音效")
			add("vjbase.menu.npc.sdsettings.togglebreathing", "禁用呼吸音效")
			add("vjbase.menu.npc.sdsettings.togglefootsteps", "禁用脚步音效")
			add("vjbase.menu.npc.sdsettings.toggleattacksounds", "禁用近战攻击音效")
			add("vjbase.menu.npc.sdsettings.togglerangeattack", "禁用远程攻击音效")
			add("vjbase.menu.npc.sdsettings.togglealert", "禁用警戒音效")
			add("vjbase.menu.npc.sdsettings.togglepain", "禁用疼痛音效")
			add("vjbase.menu.npc.sdsettings.toggledeath", "禁用死亡音效")
			add("vjbase.menu.npc.sdsettings.togglegibbing", "禁用碎尸音效")
			add("vjbase.menu.npc.sdsettings.label1", "同时也禁用碎块与其他东西碰撞时的音效")
			add("vjbase.menu.npc.sdsettings.togglemedic", "禁用医疗兵音效")
			add("vjbase.menu.npc.sdsettings.togglefollowing", "禁用跟随音效")
			add("vjbase.menu.npc.sdsettings.togglecallhelp", "禁用寻求帮助音效")
			add("vjbase.menu.npc.sdsettings.togglereceiveorder", "禁用接受命令音效")
			add("vjbase.menu.npc.sdsettings.togglebecomeenemy", "禁用成为玩家敌人音效")
			add("vjbase.menu.npc.sdsettings.toggleplayersight", "禁用发现玩家音效")
			add("vjbase.menu.npc.sdsettings.label2", "当 SNPC 看到玩家时播放的特殊音效")
			add("vjbase.menu.npc.sdsettings.toggledmgbyplayer", "禁用受到玩家攻击音效")
			add("vjbase.menu.npc.sdsettings.label3", "当玩家攻击一名 SNPC 时的音效，通常用于友方 SNPC。")
			add("vjbase.menu.npc.sdsettings.toggleleap", "禁用跳跃攻击音效")
			add("vjbase.menu.npc.sdsettings.toggleslowedplayer", "禁用玩家减速音效")
			add("vjbase.menu.npc.sdsettings.label4", "当玩家被近战攻击减速时播放的音效")
			add("vjbase.menu.npc.sdsettings.togglegrenade", "禁用手雷攻击音效")
			add("vjbase.menu.npc.sdsettings.toggledangersight", "禁用发现手雷和危险音效")
			add("vjbase.menu.npc.sdsettings.togglesuppressing", "禁用压制敌人时呼喊音效")
			add("vjbase.menu.npc.sdsettings.togglereload", "禁用换弹时呼喊音效")
			
			add("vjbase.menu.npc.devsettings", "开发者设置")
			add("vjbase.menu.npc.devsettings.label1", "这些设置用于调试 SNPC。")
			add("vjbase.menu.npc.devsettings.label2", "警告：部分选项会导致卡顿！")
			add("vjbase.menu.npc.devsettings.toggledev", "启用开发者模式？")
			add("vjbase.menu.npc.devsettings.label3", "必须从此处或通过关联菜单启用此选项(以下选项需要）")
			add("vjbase.menu.npc.devsettings.printtouch", "被触碰时输出（控制台）")
			add("vjbase.menu.npc.devsettings.printcurenemy", "输出当前的敌人（控制台）")
			add("vjbase.menu.npc.devsettings.printlastseenenemy", "输出“最后一次看见敌人”的时间（聊天框）")
			add("vjbase.menu.npc.devsettings.printonreset", "重置敌人时输出（控制台）")
			add("vjbase.menu.npc.devsettings.printonstopattack", "停止攻击时输出（控制台）")
			add("vjbase.menu.npc.devsettings.printtakingcover", "寻找掩护时输出（控制台）")
			add("vjbase.menu.npc.devsettings.printondamage", "受到伤害时输出（控制台）")
			add("vjbase.menu.npc.devsettings.printondeath", "死亡时输出（控制台）")
			add("vjbase.menu.npc.devsettings.printweaponinfo", "输出武器相关信息（控制台）")
			add("vjbase.menu.npc.devsettings.cachedmodels", "已缓存的模型（控制台）")
			add("vjbase.menu.npc.devsettings.numofnpcs", "当前 NPC 数量（聊天框）")
			add("vjbase.menu.npc.devsettings.label4", "重新加载选项：")
			add("vjbase.menu.npc.devsettings.reloadsounds", "重新加载音效")
			add("vjbase.menu.npc.devsettings.reloadmaterials", "重新加载材质（VMT）")
			add("vjbase.menu.npc.devsettings.reloadtextures", "重新加载贴图（VTF）")
			add("vjbase.menu.npc.devsettings.reloadmodels", "重新加载模型")
			add("vjbase.menu.npc.devsettings.reloadspawnmenu", "重新加载生成菜单")
			
			add("vjbase.menu.npc.consettings", "控制器设置")
			add("vjbase.menu.npc.consettings.label1", "注意：这仅是客户端设置！")
			add("vjbase.menu.npc.consettings.label2", "每次单击时缩放的距离远近。")
			add("vjbase.menu.npc.consettings.displayhud", "显示 HUD")
			add("vjbase.menu.npc.consettings.camzoomdistance", "视角移动距离")
			add("vjbase.menu.npc.consettings.camspeed", "视角速度")
			add("vjbase.menu.npc.consettings.camzoomspeed", "视角缩放速度" )
			add("vjbase.menu.npc.consettings.diewithnpc", "NPC 死亡时，控制器也失效（需要重生！）")
			add("vjbase.menu.npc.consettings.displaydev", "显示开发者模式的实体")
			add("vjbase.menu.npc.consettings.label3", "按键绑定：")
			add("vjbase.menu.npc.consettings.bind.header1", "按键")
			add("vjbase.menu.npc.consettings.bind.header2", "描述")
			add("vjbase.menu.npc.consettings.bind.clickmsg1", "已选中的按键：")
			add("vjbase.menu.npc.consettings.bind.clickmsg2", "描述：")
			add("vjbase.menu.npc.consettings.bind.movement", "移动（支持 8 个方向）")
			add("vjbase.menu.npc.consettings.bind.exitcontrol", "退出控制器")
			add("vjbase.menu.npc.consettings.bind.meleeattack", "近战攻击")
			add("vjbase.menu.npc.consettings.bind.rangeattack", "远程/武器攻击")
			add("vjbase.menu.npc.consettings.bind.leaporgrenade", "跳跃/手雷攻击")
			add("vjbase.menu.npc.consettings.bind.reloadweapon", "装填武器")
			add("vjbase.menu.npc.consettings.bind.togglebullseye", "开/关靶子跟踪")
			add("vjbase.menu.npc.consettings.bind.cameramode", "更改视角")
			add("vjbase.menu.npc.consettings.bind.movementjump", "切换移动/跳跃")
			add("vjbase.menu.npc.consettings.bind.camerazoom", "视角缩放")
			add("vjbase.menu.npc.consettings.bind.cameraup", "视角向上")
			add("vjbase.menu.npc.consettings.bind.cameradown", "视角向下")
			add("vjbase.menu.npc.consettings.bind.cameraforward", "视角向前")
			add("vjbase.menu.npc.consettings.bind.camerabackward", "视角向后")
			add("vjbase.menu.npc.consettings.bind.cameraleft", "视角向左")
			add("vjbase.menu.npc.consettings.bind.cameraright", "视角向右")
			add("vjbase.menu.npc.consettings.bind.resetzoom", "恢复视角位置")
		...
		elseif conv == "turkish" then ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			...
			add("vjbase.menu.npc.performance.processtime", "İşleme Süresi")
			add("vjbase.menu.npc.performance.processtime.button", "İşleme Süresi Nedir?")
			add("vjbase.menu.npc.performance.processtime.label", "Default: 1 | Düşük sayılar gecikmeye sebebiyet verir!")
			...
			add("vjbase.menu.npc.settings.help.chasingenemy", "UYARI: Bu Bazı AI Parçalarını Bozabilir!")
			...
			add("vjbase.menu.npc.settings.help.followplayer", "Örnek: NPC'ye doğru E'ye bastığında seni takip eder.")
			...
			add("vjbase.menu.npc.settings.help.noweapon", "İnsanlar silah kullanamayacak!")
			...
			add("vjbase.menu.npc.settings.help.idleparticles", "Bunu devre dışı bırakmak performansı artırabilir!")
			add("vjbase.menu.npc.settings.togglesnpcchat", "NPC Sohbet Yazıları Devre Dışı")
			add("vjbase.menu.npc.settings.help.npcchat", "Örnek: 'Bilim adamı seni takip ediyor!'")
			...
			add("vjbase.menu.npc.settings.help.bleeding", "Kan izleri, lekeler vs. Devre Dışı")
			...
			add("vjbase.menu.npc.settings.help.gib", "Bunu devre dışı bırakmak performansı artırabilir!")
			...
			add("vjbase.menu.npc.sdsettings", "Ses Ayarları")
			add("vjbase.menu.npc.sdsettings.toggleallsounds", "Tüm Sesler Devre Dışı")
			add("vjbase.menu.npc.sdsettings.togglesoundtrack", "Ses Parçaları/Müzik Devre Dışı")
			add("vjbase.menu.npc.sdsettings.toggleidle", "Boştaki Sesler Devre Dışı")
			add("vjbase.menu.npc.sdsettings.togglebreathing", "Nefes Alma Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.togglefootsteps", "Ayak Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.toggleattacksounds", "Yakın Saldırı Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.togglerangeattack", "Menzilli Saldırı Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.togglealert", "Uyarı Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.togglepain", "Acı Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.toggledeath", "Ölüm Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.togglegibbing", "Parçalanma Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.label1", "Ayrıca bir parça bir şeye çarptığında çıkan sesler için de geçerlidir")
			add("vjbase.menu.npc.sdsettings.togglemedic", "Şifacı Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.togglefollowing", "Takip Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.togglecallhelp", "Yardım Çağrısı Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.togglereceiveorder", "Emir Alma Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.togglebecomeenemy", "Oyuncuya Düşman Olma Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.toggleplayersight", "Oyuncu Görüşü Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.label2", "NPC'nin Oyuncuğu Gördüğündeki Özel Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.toggledmgbyplayer", "Oyuncu Tarafından Verilen Hasar Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.label3", "Bir oyuncu NPC'ye ateş ettiğinde, özellikle dost NPC'lere")
			add("vjbase.menu.npc.sdsettings.toggleleap", "Sıçrama Saldırısı Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.toggleslowedplayer", "Yavaşlamış Oyuncu Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.label4", "Oyuncu yakın hasar ile yavaşlatığındaki sesler")
			add("vjbase.menu.npc.sdsettings.togglegrenade", "El Bombası Saldırı Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.toggledangersight", "El bombası ve Tehlike Görme Sesleri Devre Dışı")
			add("vjbase.menu.npc.sdsettings.togglesuppressing", "Çağrı Seslerini Bastırma Devre Dışı")
			add("vjbase.menu.npc.sdsettings.togglereload", "Çağrı Seslerini Yineleme Devre Dışı")

			add("vjbase.menu.npc.devsettings", "Geliştirici Ayarları")
			add("vjbase.menu.npc.devsettings.label1", "Bu ayarlar SNPC'leri geliştirirken kullanılır.")
			add("vjbase.menu.npc.devsettings.label2", "UYARI: Bu seçeneklerden bazıları gecikmeye neden olabilir!")
			add("vjbase.menu.npc.devsettings.toggledev", "Geliştirici Modunu Aktif Et?")
			add("vjbase.menu.npc.devsettings.label3", "Bu seçenek buradan ya da içerik menüsünden etkinleştirilmelidir! (Aşağıdaki seçenekler için gerekli)")
			add("vjbase.menu.npc.devsettings.printtouch", "Dokunmada Yazdır (Konsola)")
			add("vjbase.menu.npc.devsettings.printcurenemy", "Mevcut düşmanı Yazdır (Konsola)")
			add("vjbase.menu.npc.devsettings.printlastseenenemy", "'LastSeenEnemy' zamanını Yazdır (Sohbete)")
			add("vjbase.menu.npc.devsettings.printonreset", "Düşmanı Sıfırlamayı Yazdır (Konsola)")
			add("vjbase.menu.npc.devsettings.printonstopattack", "Duran Saldırıları Yazdır (Konsola)")
			add("vjbase.menu.npc.devsettings.printtakingcover", "Siper Almayı Yazdır (Konsola)")
			add("vjbase.menu.npc.devsettings.printondamage", "Hasarda Yazdır (Konsola)")
			add("vjbase.menu.npc.devsettings.printondeath", "Ölümde Yazdır (Konsola)")
			add("vjbase.menu.npc.devsettings.printweaponinfo", "Silah Bilgisini Yazdır (Konsola)")
			add("vjbase.menu.npc.devsettings.cachedmodels", "Önbelleğe Alınan Modelleri Yazdır (Konsola)")
			add("vjbase.menu.npc.devsettings.numofnpcs", "NPC Sayısını Yazdır (Sohbete)")
			add("vjbase.menu.npc.devsettings.label4", "Butonları Yenile:")
			add("vjbase.menu.npc.devsettings.reloadsounds", "Sesleri Yenile")
			add("vjbase.menu.npc.devsettings.reloadmaterials", "Materyalleri Yenile (VMT)")
			add("vjbase.menu.npc.devsettings.reloadtextures", "Dokuları Yenile (VTF)")
			add("vjbase.menu.npc.devsettings.reloadmodels", "Modelleri Yenile")
			add("vjbase.menu.npc.devsettings.reloadspawnmenu", "Oluşturma Menüsünü Yenile")
			
			add("vjbase.menu.npc.consettings", "Kontrolcü Ayarları")
			add("vjbase.menu.npc.consettings.label1", "Bilgilendirme: Bu ayarlar sadece istemci taraflıdır!")
			add("vjbase.menu.npc.consettings.label2", "Yakınlaştırmanın uzaklığı veya yakınlığı her tıklamada ne kadar değişir?.")
			add("vjbase.menu.npc.consettings.displayhud", "HUD Göster")
			add("vjbase.menu.npc.consettings.camzoomdistance", "Kamera Hareket Uzaklığı")
			add("vjbase.menu.npc.consettings.camspeed", "Kamera Hızı")
			add("vjbase.menu.npc.consettings.camzoomspeed", "Kamera Yakınlaştırma Hızı" )
			add("vjbase.menu.npc.consettings.diewithnpc", "Kontrolcü NPC'ile Birlikte Ölür (Yeniden Doğma Gereklidir!)")
			add("vjbase.menu.npc.consettings.displaydev", "Geliştirici Entity'lerini Göster")
			add("vjbase.menu.npc.consettings.label3", "Tuş Atamaları:")
			add("vjbase.menu.npc.consettings.bind.header1", "Kontrol")
			add("vjbase.menu.npc.consettings.bind.header2", "Açıklama")
			add("vjbase.menu.npc.consettings.bind.clickmsg1", "Seçilen Tuş:")
			add("vjbase.menu.npc.consettings.bind.clickmsg2", "Açıklama:")
			add("vjbase.menu.npc.consettings.bind.movement", "Hareket (8-Yön Destekler)")
			add("vjbase.menu.npc.consettings.bind.exitcontrol", "Kontrolcüden Çık")
			add("vjbase.menu.npc.consettings.bind.meleeattack", "Yakın Saldırı")
			add("vjbase.menu.npc.consettings.bind.rangeattack", "Uzak / Silah Saldırısı")
			add("vjbase.menu.npc.consettings.bind.leaporgrenade", "Sıçrama / Bomba Saldırısı")
			add("vjbase.menu.npc.consettings.bind.reloadweapon", "Şarjör Değiştir")
			add("vjbase.menu.npc.consettings.bind.togglebullseye", "Hedef Takibi Aç/Kapat")
			add("vjbase.menu.npc.consettings.bind.cameramode", "Kamera Modunu Değiştir")
			add("vjbase.menu.npc.consettings.bind.movementjump", "Hareketli Atlama Aç/Kapat")
			add("vjbase.menu.npc.consettings.bind.camerazoom", "Yakınlaştır ve Uzaklaştır")
			add("vjbase.menu.npc.consettings.bind.cameraup", "Yukarı Kamera Hareketi")
			add("vjbase.menu.npc.consettings.bind.cameradown", "Aşağı Kamera Hareketi")
			add("vjbase.menu.npc.consettings.bind.cameraforward", "İleri Kamera Hareketi")
			add("vjbase.menu.npc.consettings.bind.camerabackward", "Geri Kamera Hareketi")
			add("vjbase.menu.npc.consettings.bind.cameraleft", "Sol Kamera Hareketi")
			add("vjbase.menu.npc.consettings.bind.cameraright", "Sağ Kamera Hareketi")
			add("vjbase.menu.npc.consettings.bind.resetzoom", "Kamera Pozisyonunu Sıfırla")
