...
local strings_english = {
	...
	["tool.vj_tool_equipment.selectedequipment"] = "Selected Equipment",
...
local strings_russian = {
	...
	["tool.vj_tool_equipment.selectedequipment"] = "Выбрать снаряжение",
...
local strings_lithuanian = {
	...
	["tool.vj_tool_equipment.selectedequipment"] = "Pasirinkta ginkluotė",
...
local strings_chinese_simplified = {
	...
	["tool.vj_tool_equipment.selectedequipment"] = "已选中的装备",
...
local strings_turkish = {
	...
	["tool.vj_tool_equipment.selectedequipment"] = "Seçilen Ekipman",
