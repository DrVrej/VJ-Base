...
local strings_english = {
	...
	["vjbase.menu.npc.settings.gen.difficulty.neanderthal"] = "[-5] Neanderthal | -99% Health and Damage",
	["vjbase.menu.npc.settings.gen.difficulty.puny"] = "[-4] Puny | -90% health and damage",
	["vjbase.menu.npc.settings.gen.difficulty.childs_play"] = "[-3] Child's Play | -75% Health and Damage",
	["vjbase.menu.npc.settings.gen.difficulty.easy"] = "[-2] Easy | -50% Health and Damage",
	["vjbase.menu.npc.settings.gen.difficulty.beginner"] = "[-1] Beginner | -25% health and damage",
	["vjbase.menu.npc.settings.gen.difficulty.normal"] = "[0] Normal | Original Health and Damage",
	["vjbase.menu.npc.settings.gen.difficulty.difficult"] = "[1] Difficult | 25% health and damage",
	["vjbase.menu.npc.settings.gen.difficulty.hard"] = "[2] Hard | +50% Health and Damage",
	["vjbase.menu.npc.settings.gen.difficulty.intermediate"] = "[3] Intermediate | 75% health and damage",
	["vjbase.menu.npc.settings.gen.difficulty.insane"] = "[4] Insane | +100% Health and Damage",
	["vjbase.menu.npc.settings.gen.difficulty.impossible"] = "[5] Impossible | +150% Health and Damage",
	["vjbase.menu.npc.settings.gen.difficulty.crazy"] = "[6] Crazy | 200% health and damage",
	["vjbase.menu.npc.settings.gen.difficulty.nightmare"] = "[7] Nightmare | +250% Health and Damage",
	["vjbase.menu.npc.settings.gen.difficulty.hell_on_earth"] = "[8] Hell On Earth | +350% Health and Damage",
	["vjbase.menu.npc.settings.gen.difficulty.total_annihilation"] = "[9] Total Annihilation | +500% Health and Damage",
	["vjbase.menu.npc.settings.gen.difficulty.human_eradication"] = "[10] Human Eradication | 900% health and damage",
