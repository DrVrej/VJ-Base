...
local strings_english = {
	...
	["vjbase.menu.contact"] = "Contact and Support",
	["vjbase.menu.contact.incompatibleaddons"] = "Incompatible Addons",
	["vjbase.menu.contact.reportbug"] = "Report a Bug",
	["vjbase.menu.contact.suggestion"] = "Suggest Something",
	["vjbase.menu.contact.discord"] = "Join me on Discord!",
	["vjbase.menu.contact.steam"] = "Join me on Steam!",
	["vjbase.menu.contact.youtube"] = "Subscribe me on YouTube!",
	["vjbase.menu.contact.twitter"] = "Follow me on Twitter!",
	["vjbase.menu.contact.patreon"] = "Donate me on Patreon!",
	["vjbase.menu.contact.label1"] = "Follow one of these links to get updates about my addons!",
	["vjbase.menu.contact.label2"] = "Donations help and encourage me to continue making/updating addons! Thank you!",
...
local strings_russian = {
	...
	["vjbase.menu.contact.label2"] = "Пожертвования помогают и поощряют меня продолжать делать/обновлять дополнения! Спасибо!",
...
local strings_lithuanian = {
	...
	["vjbase.menu.contact.label2"] = "Jūsų parama skatina mane toliau kurti/naujinti priedus! Ačiū!",
...
local strings_spanish_latin = {
	...
	["vjbase.menu.contact.label2"] = "¡Las donaciones me ayudan y me motivan a crear/actualizar addons! Gracias!",
...
local strings_chinese_simplified = {
	...
	["vjbase.menu.contact.label2"] = "赞助会帮助和鼓励我继续制作/更新插件！非常感谢你的支持。",
...
local strings_turkish = {
	...
	["vjbase.menu.contact.label2"] = "Bağışlar eklenti yapmaya/güncellemeye devam etmem için bana yardımcı oluyor ve beni cesaretlendiriyor! Teşekkür ederim!",
	["vjbase.menu.contact.thanks"] = "Thanks for your support!",
...
function VJ.RefreshLanguage()
	...
	MsgC(Color(255, 163, 121), "VJ Base: ", Color(255, 241, 122, 200), "Language set to ", Color(0, 255, 0), conv .. "\n")
end
