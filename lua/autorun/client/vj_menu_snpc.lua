...
local function VJ_SNPC_OPTIONS(Panel) -- Options
	...
	Panel:AddControl("Checkbox", {Label = "Humans Can Jump", Command = "vj_npc_human_canjump"})
...
local function VJ_SNPC_DEVSETTINGS(Panel) -- Developer Settings
	...
	Panel:ControlHelp("This option must be enabled from here or through the context menu! (Required for the options below)")
	...
	Panel:AddControl( "Label", {Text = "Human Settings:"})
	Panel:AddControl("Checkbox", {Label = "Print Current Weapon (Console)", Command = "vj_npc_printweapon"})
...
hook.Add("PopulateToolMenu", "VJ_ADDTOMENU_SNPC", function()
	...
	spawnmenu.AddToolMenuOption("DrVrej", "SNPCs", "NPC Controller Settings", "Controller Settings", "", "", VJ_SNPC_NPCONTROLLERSETTINGS, {})
end)