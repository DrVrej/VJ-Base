...
local function VJ_SNPC_CONTROLLERSETTINGS(Panel) -- NPC Controller Settings
	...
	ControlList:AddColumn("#vjbase.menu.snpc.consettings.bind.header2") -- Add column
		...
		ControlList:AddLine("#vjbase.menu.snpc.consettings.bind.key.fire1", "#vjbase.menu.snpc.consettings.bind.meleeattack")
		ControlList:AddLine("#vjbase.menu.snpc.consettings.bind.key.fire2", "#vjbase.menu.snpc.consettings.bind.rangeattack")
		ControlList:AddLine("#vjbase.menu.snpc.consettings.bind.key.jump", "#vjbase.menu.snpc.consettings.bind.leaporgrenade")
		ControlList:AddLine("#vjbase.menu.snpc.consettings.bind.key.reload", "#vjbase.menu.snpc.consettings.bind.reloadweapon")
		...
		ControlList:AddLine("#vjbase.menu.snpc.consettings.bind.key.mouse_wheel", "#vjbase.menu.snpc.consettings.bind.camerazoom")
		ControlList:AddLine("#vjbase.menu.snpc.consettings.bind.key.up_arrow", "#vjbase.menu.snpc.consettings.bind.cameraforward")
		ControlList:AddLine("#vjbase.menu.snpc.consettings.bind.key.up_arrow.run", "#vjbase.menu.snpc.consettings.bind.cameraup")
		ControlList:AddLine("#vjbase.menu.snpc.consettings.bind.key.down.arrow", "#vjbase.menu.snpc.consettings.bind.camerabackward")
		ControlList:AddLine("#vjbase.menu.snpc.consettings.bind.key.down.arrow.run", "#vjbase.menu.snpc.consettings.bind.cameradown")
		ControlList:AddLine("#vjbase.menu.snpc.consettings.bind.key.left.arrow", "#vjbase.menu.snpc.consettings.bind.cameraleft")
		ControlList:AddLine("#vjbase.menu.snpc.consettings.bind.key.right.arrow", "#vjbase.menu.snpc.consettings.bind.cameraright")
