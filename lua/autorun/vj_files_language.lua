...
if CLIENT then
	...
	function VJ_REFRESH_LANGUAGE()
		...
		add("vjbase.menu.snpc.settings.toggledangersight", "Disable Humans Detecting from Dangers & Grenades")
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		elseif conv == "russian" then ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			...
			add("vjbase.menu.snpc.settings.toggledangersight", "Отключить избегание гранат людьми")
			...
			add("vjbase.menu.snpc.sdsettings.toggledangersight", "Отключить звуки обнаружения гранаты")
		...
		elseif conv == "schinese" then ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			...
			add("vjbase.menu.snpc.settings.toggledangersight", "禁止人类躲避手雷")
			...
			add("vjbase.menu.snpc.sdsettings.toggledangersight", "禁用发现手雷音效")
