...
if CLIENT then
	...
	function VJ_REFRESH_LANGUAGE()
		...
		add("vjbase.menu.snpc.settings.toggledangersight", "Disable Humans Detecting Dangers & Grenades")
		...
		add("vjbase.menu.snpc.settings.togglesnpcchat", "Disable NPC Chat")
