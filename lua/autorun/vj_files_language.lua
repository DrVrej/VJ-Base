...
if CLIENT then
	...
	function VJ_REFRESH_LANGUAGE()
		...
		add("vjbase.menu.snpc.consettings.bind.key.fire1", "FIRE1")
		add("vjbase.menu.snpc.consettings.bind.key.fire2", "FIRE2")
		add("vjbase.menu.snpc.consettings.bind.key.jump", "JUMP")
		add("vjbase.menu.snpc.consettings.bind.key.reload", "RELOAD")
		add("vjbase.menu.snpc.consettings.bind.key.mouse_wheel", "MOUSE WHEEL")
		add("vjbase.menu.snpc.consettings.bind.key.up_arrow", "UP ARROW")
		add("vjbase.menu.snpc.consettings.bind.key.up_arrow.run", "UP ARROW + RUN")
		add("vjbase.menu.snpc.consettings.bind.key.down.arrow", "DOWN ARROW")
		add("vjbase.menu.snpc.consettings.bind.key.down.arrow.run", "DOWN ARROW + RUN")
		add("vjbase.menu.snpc.consettings.bind.key.left.arrow", "LEFT ARROW")
		add("vjbase.menu.snpc.consettings.bind.key.right.arrow", "RIGHT ARROW")
		...
		add("entity.vjfeature.fireplace_turnedoff", "You turned off the fireplace.")
		add("entity.vjfeature.player_spawnpoint_activated", "Activated this spawnpoint!")
		add("entity.vjfeature.player_spawnpoint_deactivated", "Deactivated this spawnpoint!")
		
		-- Weapon Names (Spawn Menu)
		add("wn.vjname.357.mag", ".357 Magnum") -- Short printname id to make it show on weapon selector
		add("wn.vjname.9mm.pistol", "9mm Pistol")
		add("weapon.vjname.ak_47", "AK-47")
		add("weapon.vjname.ar2", "AR2")
		add("weapon.vjname.blaster", "Blaster")
		add("wn.vjname.flare_gun", "Flare Gun")
		add("wn.vjname.glock_17", "Glock 17")
		add("weapon.vjname.m4a1", "M4A1")
		add("weapon.vjname.m16a1", "M16A1")
		add("weapon.vjname.mp_40", "MP 40")
		add("weapon.vjname.rpg", "RPG")
		add("weapon.vjname.smg1", "SMG1")
		add("weapon.vjname.spas_12", "SPAS-12")
		add("wn.vjname.vj_npccntrl", "VJ NPC Controller")
		
		-- VJ NPC Controller
		add("vj_npc_controller.error.player", "That's a player dumbass.")
		add("vj_npc_controller.error.ragdoll", "You are about to become that corpse.")
		add("vj_npc_controller.error.physics", "Uninstall your game. Now.")
		add("vj_npc_controller.error.no_npc", "This isn't an NPC, therefore you can't control it.")
		add("vj_npc_controller.error.dead_npc", "This NPC's health is 0 or below, therefore you can't control.")
		add("vj_npc_controller.error.tank", "Tank are not controllable yet, sorry!")
		add("vj_npc_controller.error.controlled_by_a_player", "You can't control this NPC, it's already being controlled by someone else.")
		add("vj_npc_controller.note", "NOTE: VJ NPC controller is mainly made for VJ Base SNPCs!")
		add("vj_npc_controller.hud.press_x_to_reload", "Press R to reload!")
		add("vj_npc_controller.hud.third_person", "Third")
		add("vj_npc_controller.hud.first_person", "First")
		
		-- VJ Test NPC Menu		
		add("vj_test_npc_menu_title", "VJ Test Menu")
		add("vj_test_npc_menu_suicide", "Kill Yourself")
		add("vj_test_npc_menu_admin_note", "NOTE: Only admins can use these buttons! Most of this commands require 'sv_cheats' to be 1")
		add("vj_test_npc_menu_god_mode", "Toggle God Mode")
		add("vj_test_npc_menu_buddha", "Toggle Buddha")
		add("vj_test_npc_menu_fp", "Firstperson")
		add("vj_test_npc_menu_tp", "Thirdperson")
		add("vj_test_npc_menu_illuminati", "Illuminati")
		add("vj_test_npc_menu_thirsty", "THIRSTY")
		
		-- NPC Chat Messages
		add("npc.vjchat.bulleye_activated", "Activated NPC Bullseye.")
		add("npc.vjchat.bulleye_deactivated", "Deactivated NPC Bullseye.")
		add("npc.vjchat.bulleye_tracking_activated", "Bullseye tracking activated!")
		add("npc.vjchat.bulleye_tracking_deactivated", "Bullseye tracking deactivated!")
		add("npc.vjchat.controls_help", "For controls, check \"Controller Settings\" under \"DrVrej\" tab")

		add("vjchat.these_options_are_admins_only", "These options are restricted to Admin only!")
		add("vjchat.set_no_target_to_yourself_on", "Set no target to yourself: ON")
		add("vjchat.set_no_target_to_yourself_off", "Set no target to yourself: OFF")
		add("vjchat.nothing_to_spawn", "Nothing to spawn!")
		add("vjchat.cant_be_spawned_because_its_a_spawner", "Can't be spawned because it's a spawner")
		add("vjchat.drvrej_has_joined_the_game", "DrVrej Has Joined The Game!")
		add("vjchat.drvrej_is_in_the_server", "DrVrej is in the server!")
		add("vjchat.error_outdated_version_of_garrysmod_detected", "--- Outdated version of Garry's Mod detected! ---")
