...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		add("vjbase.menu.snpc.options.difficulty.neanderthal", "原始人 | -99% 的生命值和伤害")
		add("vjbase.menu.snpc.options.difficulty.childs_play", "儿童游戏 | -75% 的生命值和伤害")
		add("vjbase.menu.snpc.options.difficulty.easy", "简单 | -50% 的生命值和伤害")
		add("vjbase.menu.snpc.options.difficulty.normal", "正常 | 原始的生命值和伤害")
		add("vjbase.menu.snpc.options.difficulty.hard", "困难 | +50% 的生命值和伤害")
		add("vjbase.menu.snpc.options.difficulty.insane", "疯狂 | +100% 的生命值和伤害")
		add("vjbase.menu.snpc.options.difficulty.impossible", "不可能 | +150% 的生命值和伤害")
		add("vjbase.menu.snpc.options.difficulty.nightmare", "噩梦 | +250% 的生命值和伤害")
		add("vjbase.menu.snpc.options.difficulty.hell_on_earth", "炼狱 | +350% 的生命值和伤害")
		add("vjbase.menu.snpc.options.difficulty.total_annihilation", "横扫千军 | +500% 的生命值和伤害")
		...
		add("vjbase.menu.snpc.settings.togglescarednade", "禁止人类躲避手雷")
		...
		add("vjbase.menu.snpc.settings.toggleflinching", "禁用退缩")
		...
		add("vjbase.menu.snpc.settings.togglegibdecals", "禁用碎块贴图")
		add("vjbase.menu.snpc.settings.togglegibdeathparticles", "禁用碎尸/死亡时的粒子效果和特效")
		...
		add("vjbase.menu.snpc.sdsettings.togglegrenadesight", "禁用发现手雷音效")
		...
		add("vjbase.menu.clweapon.togglemuzzlesmoke", "禁用枪口烟雾")
		add("vjbase.menu.clweapon.togglemuzzleheatwave", "禁用枪口热浪")
