...
SWEP.Secondary.PlayerDamage		= 15 -- Put 1 to make it the same as above
SWEP.Primary.UseNegativePlayerDamage = true -- Should it use a negative number for the player damage?
...
SWEP.Primary.DistantSound		= "vj_glock17/glock17_single_dist.wav" -- The distant sound
	-- Deployment Settings ---------------------------------------------------------------------------------------------------------------------------------------------
