...
local function VJ_SNPC_SOUNDSETTINGS( Panel ) -- Sound Settings
	...
	Panel:AddControl("Checkbox", {Label = "Disable Hurt Sounds", Command = "vj_npc_sd_pain"})
...
local function VJ_SNPC_DEVSETTINGS( Panel ) -- Developer Settings
	...
	Panel:AddControl("Checkbox", {Label = "Enable Dev Mode?", Command = "vj_npc_usedevcommands"})
	Panel:ControlHelp("Many of the command below require this to be checked!")
