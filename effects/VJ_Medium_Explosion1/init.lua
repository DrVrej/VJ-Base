...
function EFFECT:Init(data)
	...
	for i = 1,12 do
		...
		EffectCode:SetVelocity(Vector(math.random(-40,40),math.random(-40,40),math.random(30,40)))
		EffectCode:SetAirResistance(15)
		EffectCode:SetDieTime(16) -- How much time until it dies
		...
		//EffectCode:SetGravity(Vector(0,0,math.random(-100,-100))) -- The Gravity
	end
